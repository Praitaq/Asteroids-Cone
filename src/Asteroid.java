...
public class Asteroid extends BasicVectorShape {
    ...
    public double getRotationVelocity() { return this.rotVel; };
    public void setRotationVelocity(double v) { this.rotVel = v; };
